<?php // Generated with realfaviconsgenerator.net; ?>
    ...
    <link rel="icon" type="image/png" href="<?php echo url('assets/favicons/favicons-32x32.png" sizes="32x32'); ?>">
    <link rel="icon" type="image/png" href="<?php echo url('assets/favicons/android-chrome-192x192.png" sizes="192x192'); ?>">
    <link rel="icon" type="image/png" href="<?php echo url('assets/favicons/favicons-96x96.png" sizes="96x96'); ?>">
    <link rel="icon" type="image/png" href="<?php echo url('assets/favicons/favicons-16x16.png" sizes="16x16'); ?>">
    <link rel="manifest" href="<?php echo url('assets/favicons/manifest.json'); ?>">
    <link rel="mask-icon" href="<?php echo url('assets/favicons/safari-pinned-tab.svg'); ?>" color="#cc0000">
